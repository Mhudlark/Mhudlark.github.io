      ...
      <div className="relative z-20 max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              ...
              but I&apos;m most experienced in web development, particularly with React and Node. 
              My love of organisation extends into my work as I&apos;m a big fan of clean 
              and well structured code.
            </p>
            <p>
              When I need a break I love to go outside for walks and to play sport. 
              I&apos;m always keen for a kick of the footy, a hit of squash or a quick 
              bouldering session.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed mb-8">
            <p>
              I&apos;ve worked on consulting projects with 15+ people on the team, 
              and I&apos;ve also worked on smaller projects where I regularly 
          ...
          <div className="space-y-8">
            ...
            <article className="rounded-lg border border-border bg-card/50 backdrop-blur-sm overflow-hidden">
              <div className="aspect-video relative">
                <img
                  src="https://www.hughcthenry.com/assets/images/projects/mlvet/MLVET.png"
            ...
            <article className="rounded-lg border border-border bg-card/50 backdrop-blur-sm overflow-hidden">
              <div className="grid grid-cols-3 gap-1">
                <img
                  src="https://www.hughcthenry.com/assets/images/projects/lah/screenshot1.png"
                  alt="Lah gameplay screenshot 1"
                  className="w-full h-full object-cover aspect-[9/16]"
                />
                <img
                  src="https://www.hughcthenry.com/assets/images/projects/lah/screenshot2.png"
                  alt="Lah gameplay screenshot 2"
                  className="w-full h-full object-cover aspect-[9/16]"
                />
                <img
                  src="https://www.hughcthenry.com/assets/images/projects/lah/screenshot3.png"
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Lah is a mobile game hosted on the Google Play Store. It is a 2D platformer/endless 
                  jumping game where players must climb blocks to evade the lava rising from below. 
                  The game is written in C# and was built using Unity.
                </p>
